...
[![GoDoc](https://pkg.go.dev/badge/github.com/Suited-Entertainment/solana-go?status.svg)](https://pkg.go.dev/github.com/Suited-Entertainment/solana-go@v1.12.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/Suited-Entertainment/solana-go?include_prereleases&label=release-tag)](https://github.com/Suited-Entertainment/solana-go/releases)
[![Build Status](https://github.com/Suited-Entertainment/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/Suited-Entertainment/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/Suited-Entertainment/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/Suited-Entertainment/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/Suited-Entertainment/solana-go)](https://goreportcard.com/report/github.com/Suited-Entertainment/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/Suited-Entertainment/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/Suited-Entertainment/solana-go@v1.12.0
```
...
You can wait for a transaction confirmation using the `github.com/Suited-Entertainment/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/Suited-Entertainment/solana-go/programs/address-lookup-table"
...
import (
  ...
  "github.com/Suited-Entertainment/solana-go"
  "github.com/Suited-Entertainment/solana-go/programs/system"
  "github.com/Suited-Entertainment/solana-go/rpc"
  "github.com/Suited-Entertainment/solana-go/text"
)
...
import (
  ...
  "github.com/Suited-Entertainment/solana-go/rpc"
  "github.com/Suited-Entertainment/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/Suited-Entertainment/solana-go/programs/system"
  "github.com/Suited-Entertainment/solana-go/rpc"
  confirm "github.com/Suited-Entertainment/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/Suited-Entertainment/solana-go/rpc/jsonrpc"
  "github.com/Suited-Entertainment/solana-go/rpc/ws"
  "github.com/Suited-Entertainment/solana-go/text"
)
...
import (
  ...
  "github.com/Suited-Entertainment/solana-go/programs/token"
  "github.com/Suited-Entertainment/solana-go/rpc"
)
